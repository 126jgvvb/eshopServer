...
function getAnAcceptPaymentPage(settingObj,callback) {
...
var setting = new ApiContracts.SettingType();
	...
	for(let setter of settingObj.settings){
		setting.setSettingName(setter.name);
		setting.setSettingValue(setter.value);
