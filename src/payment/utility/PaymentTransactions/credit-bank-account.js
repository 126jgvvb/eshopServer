...
function creditBankAccount(customerObj, callback) {
	...
	//added code
	var bankAccountNum =customerObj.accountNumber;		// Math.floor(Math.random() * 9999999999) + 10000;
	...
	transactionRequestType.setRefTransId(customerObj.transactionID);
