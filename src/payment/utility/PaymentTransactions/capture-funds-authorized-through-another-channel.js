...
function captureFundsAuthorizedThroughAnotherChannel(customerObj,callback) {
	...
	creditCard.setCardNumber(customerObj.cardDetails.cardNumber);
	creditCard.setExpirationDate(customerObj.cardDetails.expiryDate);
	...
	transactionRequestType.setAmount(customerObj.amount);
	transactionRequestType.setAuthCode(customerObj.authCode);		//'ROHNFQ'
