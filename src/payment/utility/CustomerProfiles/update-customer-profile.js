...
function updateCustomerProfile(customerObj, callback) {
	...
	customerDataForUpdate.setMerchantCustomerId(customerObj.merchantID);
	customerDataForUpdate.setDescription(customerObj.description);
	customerDataForUpdate.setEmail(customerObj.email);
	customerDataForUpdate.setCustomerProfileId(customerObj.ID);
